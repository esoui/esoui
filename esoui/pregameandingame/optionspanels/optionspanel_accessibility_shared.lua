...
local ZO_Panel_Accessibility_ControlData =
{
    [SETTING_TYPE_ACCESSIBILITY] =
    {
        ...
        [ACCESSIBILITY_SETTING_GAMEPAD_AIM_ASSIST_INTENSITY] =
        {
            ...
            panel = SETTING_PANEL_ACCESSIBILITY,
            text = ZO_IsConsoleOrGameCoreUI() and GetString(SI_ACCESSIBILITY_OPTIONS_CONSOLE_GAMEPAD_AIM_ASSIST_INTENSITY) or GetString(SI_ACCESSIBILITY_OPTIONS_GAMEPAD_AIM_ASSIST_INTENSITY),
            tooltipText = ZO_IsConsoleOrGameCoreUI() and GetString(SI_ACCESSIBILITY_OPTIONS_CONSOLE_GAMEPAD_AIM_ASSIST_INTENSITY_TOOLTIP) or GetString(SI_ACCESSIBILITY_OPTIONS_GAMEPAD_AIM_ASSIST_INTENSITY_TOOLTIP),
            minValue = 0,
            maxValue = 100,
            showValue = true,
            exists = ZO_IsIngameUI,
