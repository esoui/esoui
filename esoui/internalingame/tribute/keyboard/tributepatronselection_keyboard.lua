local PATRON_TILE_GRID_PADDING_X = 10
ZO_TRIBUTE_PATRON_SELECTION_KEYBOARD_HEADER_WIDTH = (ZO_TRIBUTE_PATRON_BOOK_TILE_WIDE_WIDTH_KEYBOARD * 4) + (PATRON_TILE_GRID_PADDING_X * 3)
