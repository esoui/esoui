...
function DirectPurchase_Manager:Initialize()
    ...
    local function OnConfirmPurchase(_, skuId)
        ...
        if IsInGamepadPreferredMode() then
            ...
            ZO_Dialogs_ShowDialog("DIRECT_PURCHASE_CONFIRM_PURCHASE_KEYBOARD", data)
        end
    end

    EVENT_MANAGER:RegisterForEvent("DirectPurchase_Manager", EVENT_DIRECT_PURCHASE_CONFIRM_PURCHASE, OnConfirmPurchase)
end
