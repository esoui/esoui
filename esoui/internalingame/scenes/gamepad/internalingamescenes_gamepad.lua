...
ZO_GAMEPAD_GILDBAR_MARKET_PRE_SCENE:AddFragmentGroup(ZO_GAMEPAD_MARKET_KEYBINDS_FRAGMENT_GROUP)
ZO_GAMEPAD_GILDBAR_MARKET_PRE_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_1_2_3_BACKGROUND_FRAGMENT)
