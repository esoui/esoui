...
function ZO_GamepadGildbarMarket_PreScene_OnInitialize(control)
    ...
    local PRE_SCENE_FRAGMENT = ZO_FadeSceneFragment:New(control)
    ZO_GILDBAR_MARKET_PRE_SCENE = GamepadMarketPreScene:New(control, MARKET_TEMPLATE, PRE_SCENE_NAME, PRE_SCENE_FRAGMENT)
    ZO_GAMEPAD_GILDBAR_MARKET_PRE_SCENE = ZO_GILDBAR_MARKET_PRE_SCENE:GetScene()
end