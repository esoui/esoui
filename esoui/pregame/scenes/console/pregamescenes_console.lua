...
PREGAME_INITIAL_SCREEN_CONSOLE_SCENE:AddFragment(CLOUDS_BACKGROUND_FRAGMENT)
...
GAME_STARTUP_MAIN_GAMEPAD_SCENE:AddFragment(CLOUDS_BACKGROUND_FRAGMENT)
...
GAME_STARTUP_INITIAL_SERVER_SELECT_GAMEPAD_SCENE:AddFragment(CLOUDS_BACKGROUND_FRAGMENT)
...
LEGAL_AGREEMENTS_GAMEPAD_SCENE:AddFragment(CLOUDS_BACKGROUND_FRAGMENT)
...
CREATE_LINK_ACCOUNT_SCREEN_GAMEPAD_SCENE:AddFragment(CLOUDS_BACKGROUND_FRAGMENT)
...
GAMEPAD_CREDITS_ROOT_SCENE:AddFragment(CREDIT_GAMEPAD_BACKGROUND_FRAGMENT)
