...
function LavaBurst:InitializeSparksParticleSystem()
    ...
    sparksParticleSystem:SetParticleParameter("ColorREasing", ColorEasing)
    sparksParticleSystem:SetParticleParameter("ColorGEasing", ColorEasing)
    sparksParticleSystem:SetParticleParameter("ColorBEasing", ColorEasing)
