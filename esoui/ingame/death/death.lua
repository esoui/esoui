...
function BGDeath:UpdateRespawnCountdown(currentFrameTimeSeconds)
    ...
    if IsQueuedForBattleGroundRespawn() then
        ...
        local secondsToWait = (self.respawnCooldown.cooldownEndMS - currentFrameTimeMS) / 1000
        local timeLeft = ""
        ...
        respawnButton:SetText(zo_strformat(SI_DEATH_PROMPT_WAITING_RELEASE, timeLeft))
    end
end
