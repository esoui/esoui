...
MAIN_MENU_CATEGORY_DISABLED_WHILE_NO_TAMRIEL_TOMES_ARE_AVAILABLE = 7

--Main Menu Categories

MENU_CATEGORY_MARKET = 1
MENU_CATEGORY_CROWN_CRATES = 2
MENU_CATEGORY_TAMRIEL_TOMES = 3
MENU_CATEGORY_INVENTORY = 4
MENU_CATEGORY_CHARACTER = 5
MENU_CATEGORY_SKILLS = 6
MENU_CATEGORY_CHAMPION = 7
MENU_CATEGORY_JOURNAL = 8
MENU_CATEGORY_COLLECTIONS = 9
MENU_CATEGORY_MAP = 10
MENU_CATEGORY_GROUP = 11
MENU_CATEGORY_CONTACTS = 12
MENU_CATEGORY_GUILDS = 13
MENU_CATEGORY_ALLIANCE_WAR = 14
MENU_CATEGORY_MAIL = 15
MENU_CATEGORY_NOTIFICATIONS = 16
MENU_CATEGORY_HELP = 17
MENU_CATEGORY_ACTIVITY_FINDER = 18
MENU_CATEGORY_GIFT_INVENTORY = 19
