...
local ZO_GamepadEsoPlusSubscriptionStatusProvider = ZO_EsoPlusSubscriptionStatusProvider:Subclass()
...
local ZO_GamepadGiftingUnlockedProvider = ZO_GiftingUnlockedProvider:Subclass()
