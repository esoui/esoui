...
local ARMOR_AND_WEAPONS_FOR_COMPANIONS_CATEGORY_MAP = 
{
    ...
    [GAMEPAD_ITEM_CATEGORY_BOW]       = GAMEPAD_ITEM_CATEGORY_COMPANION_BOW,
    [GAMEPAD_ITEM_CATEGORY_CHEST]     = GAMEPAD_ITEM_CATEGORY_COMPANION_CHEST,
    [GAMEPAD_ITEM_CATEGORY_DAGGER]    = GAMEPAD_ITEM_CATEGORY_COMPANION_DAGGER,
    [GAMEPAD_ITEM_CATEGORY_FEET]      = GAMEPAD_ITEM_CATEGORY_COMPANION_FEET,
    [GAMEPAD_ITEM_CATEGORY_HAMMER]    = GAMEPAD_ITEM_CATEGORY_COMPANION_HAMMER,
    [GAMEPAD_ITEM_CATEGORY_HANDS]     = GAMEPAD_ITEM_CATEGORY_COMPANION_HANDS,
    [GAMEPAD_ITEM_CATEGORY_HEAD]      = GAMEPAD_ITEM_CATEGORY_COMPANION_HEAD,
    [GAMEPAD_ITEM_CATEGORY_LEGS]      = GAMEPAD_ITEM_CATEGORY_COMPANION_LEGS,
    [GAMEPAD_ITEM_CATEGORY_RING]      = GAMEPAD_ITEM_CATEGORY_COMPANION_RING,
    [GAMEPAD_ITEM_CATEGORY_SHIELD]    = GAMEPAD_ITEM_CATEGORY_COMPANION_SHIELD,
    [GAMEPAD_ITEM_CATEGORY_SHOULDERS] = GAMEPAD_ITEM_CATEGORY_COMPANION_SHOULDERS,
    [GAMEPAD_ITEM_CATEGORY_STAFF]     = GAMEPAD_ITEM_CATEGORY_COMPANION_STAFF,
    [GAMEPAD_ITEM_CATEGORY_SWORD]     = GAMEPAD_ITEM_CATEGORY_COMPANION_SWORD,
    [GAMEPAD_ITEM_CATEGORY_WAIST]     = GAMEPAD_ITEM_CATEGORY_COMPANION_WAIST,
}
