...
local HUD_FRAGMENT_GROUP =
{
    ...
    TIMED_ACTIVITY_TRACKER_FRAGMENT,
    ACHIEVEMENT_TRACKER_FRAGMENT,
...
---------------------------
--Keyboard HUD Editor Scene
---------------------------
if HUD_EDITOR_SCENE_KEYBOARD then
    HUD_EDITOR_SCENE_KEYBOARD:AddFragmentGroup(FRAGMENT_GROUP.MOUSE_DRIVEN_UI_WINDOW_NO_KEYBIND_STRIP)
    HUD_EDITOR_SCENE_KEYBOARD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
    HUD_EDITOR_SCENE_KEYBOARD:AddFragmentGroup(HUD_FRAGMENT_GROUP)
end