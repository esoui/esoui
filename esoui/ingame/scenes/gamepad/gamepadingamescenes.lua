...
local helpQuestAssistanceGamepadScene = SCENE_MANAGER:GetScene(HELP_QUEST_ASSISTANCE_GAMEPAD:GetSceneName())
...
local helpItemAssistanceGamepadScene = SCENE_MANAGER:GetScene(HELP_ITEM_ASSISTANCE_GAMEPAD:GetSceneName())
...
-----------------------
--Gamepad Dyeing Root Scene
-----------------------

GAMEPAD_DYEING_ROOT_SCENE:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(GAMEPAD_DYEING_FRAGMENT)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(GAMEPAD_DYEING_ROOT_FRAGMENT)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_1_BACKGROUND_FRAGMENT)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_2_BACKGROUND_FRAGMENT)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(MINIMIZE_CHAT_FRAGMENT)
GAMEPAD_DYEING_ROOT_SCENE:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)

-----------------------
--Gamepad Dyeing Items Scene
-----------------------

GAMEPAD_DYEING_ITEMS_SCENE:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(GAMEPAD_DYEING_FRAGMENT)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(GAMEPAD_DYEING_ITEMS_FRAGMENT)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_1_BACKGROUND_FRAGMENT)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_2_3_BACKGROUND_FRAGMENT)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(MINIMIZE_CHAT_FRAGMENT)
GAMEPAD_DYEING_ITEMS_SCENE:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
...
GAMEPAD_HOUSING_FURNITURE_BROWSER_SCENE:AddFragment(FURNITURE_BROWSER_GAMEPAD_ITEM_PREVIEW_OPTIONS_FRAGMENT)
