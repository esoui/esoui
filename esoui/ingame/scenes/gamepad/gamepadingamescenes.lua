...
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD_RIGHT)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(UNIFORM_BLUR_FRAGMENT)
