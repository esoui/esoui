...
SCENE_MANAGER:AddSceneGroup("gamepad_returningPlayer_scenegroup", ZO_SceneGroup:New(RETURNING_PLAYER_INTRO_SCENE_GAMEPAD:GetName(), RETURNING_PLAYER_REWARD_SCENE_GAMEPAD:GetName()))
...
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
...
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragmentGroup(ZO_ITEM_PREVIEW_LIST_HELPER_GAMEPAD_FRAGMENT_GROUP)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(STOP_MOVEMENT_FRAGMENT)
...
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
...
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(STOP_MOVEMENT_FRAGMENT)

TAMRIEL_TOMES_SCENE_GROUP_GAMEPAD = ZO_SceneGroup:New(TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_SCENE_GAMEPAD:GetName(), TIMED_ACTIVITIES_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:GetName())
