...
COMPANION_ROOT_GAMEPAD_SCENE:AddFragment(FRAME_TARGET_BLUR_QUADRANT_3_GAMEPAD_FRAGMENT)
...
GAMEPAD_COMPANION_OUTFITS_SELECTION_SCENE:AddFragment(FRAME_TARGET_BLUR_QUADRANT_3_GAMEPAD_FRAGMENT)
