...
LORE_READER_CUSTOM_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
LORE_READER_CUSTOM_SCENE_GAMEPAD:AddFragment(LORE_READER_FRAGMENT)
LORE_READER_CUSTOM_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
LORE_READER_CUSTOM_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
...
GAMEPAD_WORLD_MAP_SCENE:AddFragment(MAP_WINDOW_SOUNDS)
...
GAMEPAD_RETRAIT_SCENE:AddFragment(GAMEPAD_CRAFTING_RESULTS_FRAGMENT)
...
GAMEPAD_RECONSTRUCT_SCENE:AddFragment(GAMEPAD_CRAFTING_RESULTS_FRAGMENT)
...
local gamepadGildbarMarketPreScene = ZO_RemoteScene:New("gamepad_gildbar_market_pre_scene", SCENE_MANAGER)
gamepadGildbarMarketPreScene:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
gamepadGildbarMarketPreScene:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD_LEFT)
gamepadGildbarMarketPreScene:AddFragment(MINIMIZE_CHAT_FRAGMENT)
...
TIMED_ACTIVITIES_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)
TIMED_ACTIVITIES_SCENE_GAMEPAD:AddFragment(GAMEPAD_GENERIC_FOOTER_FRAGMENT)
...
RETURNING_PLAYER_INTRO_SCENE_GAMEPAD:AddFragment(PROMOTIONAL_EVENT_PERSONAL_CAMPAIGN_ANNOUNCEMENT_ACTION_LAYER_FRAGMENT)
...
RETURNING_PLAYER_REWARD_SCENE_GAMEPAD:AddFragment(PROMOTIONAL_EVENT_PERSONAL_CAMPAIGN_ANNOUNCEMENT_ACTION_LAYER_FRAGMENT)

------------------------
--Low Level Player Scene
------------------------

LOW_LEVEL_PLAYER_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_NO_KEYBIND_BACKGROUND_WINDOW)
LOW_LEVEL_PLAYER_SCENE_GAMEPAD:AddFragment(UNIFORM_BLUR_FRAGMENT)
LOW_LEVEL_PLAYER_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
LOW_LEVEL_PLAYER_SCENE_GAMEPAD:AddFragment(PROMOTIONAL_EVENT_PERSONAL_CAMPAIGN_ANNOUNCEMENT_ACTION_LAYER_FRAGMENT)
...
TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD)
TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:AddFragment(UNIFORM_BLUR_FRAGMENT)
TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)

TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD)
-- The preview options fragment needs to be added before the ITEM_PREVIEW_GAMEPAD fragment.
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(GAMEPAD_RIGHT_TOOLTIP_ITEM_PREVIEW_OPTIONS_FRAGMENT)
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(STOP_MOVEMENT_FRAGMENT)
TAMRIEL_TOMES_SCENE_GAMEPAD:AddFragment(PREVIEW_KEYBIND_INTERCEPT_LAYER_FRAGMENT)

TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_CENTERED_NO_BLUR)
-- The preview options fragment needs to be added before the ITEM_PREVIEW_GAMEPAD fragment.
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(GAMEPAD_RIGHT_TOOLTIP_ITEM_PREVIEW_OPTIONS_FRAGMENT)
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)

TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(STOP_MOVEMENT_FRAGMENT)
TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:AddFragment(PREVIEW_KEYBIND_INTERCEPT_LAYER_FRAGMENT)

TAMRIEL_TOMES_PURCHASE_PREVIEW_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TAMRIEL_TOMES_PURCHASE_PREVIEW_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD_LEFT)
-- The preview options fragment needs to be added before the ITEM_PREVIEW_GAMEPAD fragment
TAMRIEL_TOMES_PURCHASE_PREVIEW_SCENE_GAMEPAD:AddFragment(GAMEPAD_RIGHT_TOOLTIP_ITEM_PREVIEW_OPTIONS_FRAGMENT)
TAMRIEL_TOMES_PURCHASE_PREVIEW_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
TAMRIEL_TOMES_PURCHASE_PREVIEW_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)

TAMRIEL_TOMES_SCENE_GROUP_GAMEPAD = ZO_SceneGroup:New(TAMRIEL_TOMES_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_INTRO_SCENE_GAMEPAD:GetName(), TIMED_ACTIVITIES_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_PURCHASE_SCENE_GAMEPAD:GetName(), TAMRIEL_TOMES_PREVIEW_REWARD_SCENE_GAMEPAD:GetName())
SCENE_MANAGER:AddSceneGroup("gamepad_tamrielTomes_scenegroup", TAMRIEL_TOMES_SCENE_GROUP_GAMEPAD)

TAMRIEL_TOMES_SCENE_GROUP_GAMEPAD:RegisterCallback("StateChange", function(_, newState)
...
ADVENTURE_ZONE_OVERVIEW_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
ADVENTURE_ZONE_OVERVIEW_SCENE_GAMEPAD:AddFragment(UNIFORM_BLUR_FRAGMENT)
ADVENTURE_ZONE_OVERVIEW_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
ADVENTURE_ZONE_OVERVIEW_SCENE_GAMEPAD:AddFragment(GAMEPAD_GENERIC_FOOTER_FRAGMENT)

---------------------------------
-- Adventure Zone Boss Tree Scene
---------------------------------

ADVENTURE_ZONE_BOSS_TREE_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
ADVENTURE_ZONE_BOSS_TREE_SCENE_GAMEPAD:AddFragment(UNIFORM_BLUR_FRAGMENT)
ADVENTURE_ZONE_BOSS_TREE_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
ADVENTURE_ZONE_BOSS_TREE_SCENE_GAMEPAD:AddFragment(GAMEPAD_GENERIC_FOOTER_FRAGMENT)

------------------------------
-- Preview Scene
------------------------------

PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_CENTERED_NO_BLUR)
-- The preview options fragment needs to be added before the ITEM_PREVIEW_GAMEPAD fragment,
-- which is part of ZO_ITEM_PREVIEW_LIST_HELPER_GAMEPAD_FRAGMENT_GROUP
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(GAMEPAD_RIGHT_TOOLTIP_MOUNTED_ITEM_PREVIEW_OPTIONS_FRAGMENT)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragmentGroup(ZO_ITEM_PREVIEW_LIST_HELPER_GAMEPAD_FRAGMENT_GROUP)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_REWARD_TRACK_BOOK)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)
PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:AddFragment(STOP_MOVEMENT_FRAGMENT)

------------------------------
-- Veterancy Scenes
------------------------------

VETERANCY_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
VETERANCY_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_CENTERED)
-- The preview options fragment needs to be added before the ITEM_PREVIEW_GAMEPAD fragment.
VETERANCY_SCENE_GAMEPAD:AddFragment(GAMEPAD_RIGHT_TOOLTIP_MOUNTED_ITEM_PREVIEW_OPTIONS_FRAGMENT)
VETERANCY_SCENE_GAMEPAD:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
VETERANCY_SCENE_GAMEPAD:AddFragment(FRAME_EMOTE_FRAGMENT_VETERANCY)
VETERANCY_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
VETERANCY_SCENE_GAMEPAD:AddFragment(PREVIEW_KEYBIND_INTERCEPT_LAYER_FRAGMENT)

VETERANCY_SCENE_GROUP_GAMEPAD = ZO_SceneGroup:New(VETERANCY_SCENE_GAMEPAD:GetName(), PREVIEW_SCREEN_ACTIVE_PREVIEW_SCENE_GAMEPAD:GetName())

----------------------------------
-- Gamepad Guild Mail Send Screen
----------------------------------

GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragmentGroup(FRAGMENT_GROUP.FRAME_TARGET_GAMEPAD_RIGHT)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragment(GAMEPAD_GUILD_MAIL_SEND_FRAGMENT)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_1_BACKGROUND_FRAGMENT)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragment(GAMEPAD_NAV_QUADRANT_2_3_4_BACKGROUND_FRAGMENT)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragment(MINIMIZE_CHAT_FRAGMENT)
GAMEPAD_GUILD_MAIL_MANAGEMENT_SEND_SCENE:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)

----------------------------------
-- Gamepad Trial Progression Screen
----------------------------------

TRIAL_PROGRESSION_SCENE_GAMEPAD:AddFragmentGroup(FRAGMENT_GROUP.GAMEPAD_DRIVEN_UI_WINDOW)
TRIAL_PROGRESSION_SCENE_GAMEPAD:AddFragment(GAMEPAD_NAV_QUADRANT_1_2_3_4_BACKGROUND_FRAGMENT)
TRIAL_PROGRESSION_SCENE_GAMEPAD:AddFragment(MINIMIZE_CHAT_FRAGMENT)
TRIAL_PROGRESSION_SCENE_GAMEPAD:AddFragment(GAMEPAD_MENU_SOUND_FRAGMENT)