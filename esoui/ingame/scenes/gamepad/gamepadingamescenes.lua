...
GAMEPAD_COLLECTIONS_BOOK_SCENE:AddFragment(GAMEPAD_RESTYLE_PREVIEW_OPTIONS_FRAGMENT)
...
GAMEPAD_RESTYLE_STATION_SCENE:AddFragment(GAMEPAD_RESTYLE_PREVIEW_OPTIONS_FRAGMENT)
...
GAMEPAD_OUTFITS_SELECTION_SCENE:AddFragment(GAMEPAD_RESTYLE_PREVIEW_OPTIONS_FRAGMENT)
...
ZO_GAMEPAD_CHAPTER_UPGRADE_PREVIEW_SCENE:AddFragment(ITEM_PREVIEW_GAMEPAD:GetFragment())
