FRAGMENT_GROUP =
{
    ...
    FRAME_TARGET_OPTIONS =
    {
        ...
        FRAME_PLAYER_FRAGMENT,
        FRAME_TARGET_BLUR_OPTIONS_FRAGMENT,
    },
    ...
    FRAME_TARGET_TRADING_HOUSE_GAMEPAD =
    {
        FRAME_TARGET_TRADING_HOUSE_GAMEPAD_FRAGMENT,
        FRAME_TARGET_TRADING_HOUSE_BLUR_GAMEPAD_FRAGMENT,
        FRAME_PLAYER_FRAGMENT,
    },
