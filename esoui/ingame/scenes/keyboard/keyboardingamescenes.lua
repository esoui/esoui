...
LORE_READER_CUSTOM_SCENE_KEYBOARD:AddFragmentGroup(FRAGMENT_GROUP.MOUSE_DRIVEN_UI_WINDOW)
LORE_READER_CUSTOM_SCENE_KEYBOARD:AddFragment(LORE_READER_FRAGMENT)
LORE_READER_CUSTOM_SCENE_KEYBOARD:AddFragment(PLAYER_PROGRESS_BAR_FRAGMENT)
...
COMPANION_CHARACTER_KEYBOARD_SCENE:AddFragment(FRAME_TARGET_COMPANION_FRAGMENT)
...
COMPANION_SKILLS_KEYBOARD_SCENE:AddFragment(FRAME_TARGET_COMPANION_FRAGMENT)
...
COMPANION_COLLECTION_BOOK_KEYBOARD_SCENE:AddFragment(FRAME_TARGET_COMPANION_FRAGMENT)
...
---------------------------
-- Trial Progression Scene
---------------------------

TRIAL_PROGRESSION_SCENE_KEYBOARD:AddFragmentGroup(FRAGMENT_GROUP.MOUSE_DRIVEN_UI_WINDOW)
TRIAL_PROGRESSION_SCENE_KEYBOARD:AddFragment(MINIMIZE_CHAT_FRAGMENT)