...
BATTLEGROUND_SCOREBOARD_END_OF_GAME_SCENE:AddFragment(BATTLEGROUND_SCOREBOARD_BLOCKING_ACTION_LAYER_FRAGMENT)
...
BATTLEGROUND_SCOREBOARD_IN_GAME_SCENE:AddFragment(BATTLEGROUND_SCOREBOARD_BLOCKING_ACTION_LAYER_FRAGMENT)
