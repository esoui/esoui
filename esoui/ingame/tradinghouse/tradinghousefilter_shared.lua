...
{
    { ITEMTYPE_POTION_BASE, nil, GetString("SI_ITEMTYPE", ITEMTYPE_POTION_BASE) },
    { ITEMTYPE_POISON_BASE, nil, GetString("SI_ITEMTYPE", ITEMTYPE_POISON_BASE) },
...
{
    { BLACKSMITHING_SEARCH,  nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_BLACKSMITHING) },
    { CLOTHING_SEARCH,       nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_CLOTHIER) },
    { WOODWORKING_SEARCH,    nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_WOODWORKING) },
    { ENCHANTING_SEARCH,     nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_ENCHANTING) }, 
    { ALCHEMY_SEARCH,        nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_ALCHEMY) },
    { PROVISIONING_SEARCH,   nil, ZO_GetCraftingSkillName(CRAFTING_TYPE_PROVISIONING) },
}
