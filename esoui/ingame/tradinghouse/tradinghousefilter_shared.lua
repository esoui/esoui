...
local BLACKSMITHING_SEARCH =
{
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_BLACKSMITHING, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_BLACKSMITHING) },
}
...
local CLOTHING_SEARCH =
{
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_CLOTHIER, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_CLOTHIER) },
}
...
local WOODWORKING_SEARCH =
{
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_WOODWORKING, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_WOODWORKING) },
}

local JEWELRYCRAFTING_SEARCH =
{
    { SPECIALIZED_ITEMTYPE_JEWELRY_TRAIT, "jewelry", GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRY_TRAIT) },
    { {SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_MATERIAL, SPECIALIZED_ITEMTYPE_RAW_MATERIAL, SPECIALIZED_ITEMTYPE_JEWELRY_RAW_TRAIT, SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_BOOSTER, }, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_RAW_MATERIAL) },
    { SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_MATERIAL, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_MATERIAL) },
    { SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_BOOSTER, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_JEWELRYCRAFTING_BOOSTER) },
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_JEWELRYCRAFTING, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_JEWELRYCRAFTING) },
}
...
local ENCHANTING_SEARCH =
{
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ENCHANTING, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ENCHANTING) },
}
...
local ALCHEMY_SEARCH =
{
    ...
    { { SPECIALIZED_ITEMTYPE_REAGENT_HERB, SPECIALIZED_ITEMTYPE_REAGENT_FUNGUS, SPECIALIZED_ITEMTYPE_REAGENT_ANIMAL_PART}, nil, GetString("SI_ITEMTYPE", ITEMTYPE_REAGENT) },
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ALCHEMY, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_ALCHEMY) },
}
...
local PROVISIONING_SEARCH =
{
    ...
    { SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_PROVISIONING, nil, GetString("SI_SPECIALIZEDITEMTYPE", SPECIALIZED_ITEMTYPE_FURNISHING_MATERIAL_PROVISIONING) },
}
...
ZO_TRADING_HOUSE_FILTER_CRAFTING_SEARCHES =
{
    ...
    { JEWELRYCRAFTING_SEARCH, nil, GetCraftingSkillName(CRAFTING_TYPE_JEWELRYCRAFTING) },
...
do
    ...
    local JEWELRY_TRAIT_DATA =
    {
        ...
        { ITEM_TRAIT_TYPE_JEWELRY_INTRICATE, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_INTRICATE) },
        ...
        { ITEM_TRAIT_TYPE_JEWELRY_TRIUNE, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_TRIUNE) },
        { ITEM_TRAIT_TYPE_JEWELRY_INFUSED, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_INFUSED) },
        { ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE) },
        { ITEM_TRAIT_TYPE_JEWELRY_SWIFT, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_SWIFT) },
        { ITEM_TRAIT_TYPE_JEWELRY_HARMONY, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_HARMONY) },
        { ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY, nil, GetString("SI_ITEMTRAITTYPE", ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY) },
    }
...
ZO_TRADING_HOUSE_FILTER_FURNITURE_ITEM_TYPE_DATA =
{
    { { SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING,
        ...
        SPECIALIZED_ITEMTYPE_FURNISHING_ATTUNABLE_STATION }, nil, SI_TRADING_HOUSE_BROWSE_ITEM_TYPE_FURNISHINGS_ITEMS_AND_RECIPES },
    { { SPECIALIZED_ITEMTYPE_FURNISHING_ORNAMENTAL,
        SPECIALIZED_ITEMTYPE_FURNISHING_LIGHT,
        SPECIALIZED_ITEMTYPE_FURNISHING_SEATING,
        SPECIALIZED_ITEMTYPE_FURNISHING_CRAFTING_STATION,
        SPECIALIZED_ITEMTYPE_FURNISHING_TARGET_DUMMY,
        SPECIALIZED_ITEMTYPE_FURNISHING_ATTUNABLE_STATION } , nil, SI_TRADING_HOUSE_BROWSE_ITEM_TYPE_FURNISHINGS_ITEMS_ONLY },
    { { SPECIALIZED_ITEMTYPE_RECIPE_BLACKSMITHING_DIAGRAM_FURNISHING,
        SPECIALIZED_ITEMTYPE_RECIPE_CLOTHIER_PATTERN_FURNISHING,
        SPECIALIZED_ITEMTYPE_RECIPE_ENCHANTING_SCHEMATIC_FURNISHING,
        SPECIALIZED_ITEMTYPE_RECIPE_ALCHEMY_FORMULA_FURNISHING,
