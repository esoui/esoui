...
SLASH_COMMANDS[GetString(SI_SLASH_ENCOUNTER_LOG)] = function(args)
    if args == "format" then
        ...
        PrintLineTypeInfo("BEGIN_LOG", "timeSinceEpochMS", "logVersion", "realmName", "language")
        ...
        PrintLineTypeInfo("EFFECT_INFO", "abilityId", "effectType", "statusEffectType", "noEffectBar")
