...
function ZO_GuildRecruitment_Applications_Gamepad:InitializeConfirmAcceptDialog()
    local function ReleaseDialog(acceptApplication)
        ...
        parametricList =
        {
            ...
            -- Decline applicant
            {
                ...
                templateData = {
                    ...
                    callback = function(dialog)
                        DeclineGuildApplication(dialog.data.guildId, dialog.data.index, self.declineMessage, self.addToBlacklist, self.blacklistNote)
                        ReleaseDialog()
                    end,
                },
            },
                    ...
                    callback = function(dialog)
                        ...
                        if selectedData then
                            local function ReportCallback()
                                ...
                                DeclineGuildApplication(selectedData.guildId, selectedData.index, NO_MESSAGE, BLACKLIST, NO_MESSAGE)
                            end
