...
ZO_GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD_NAME_COLUMN_SIZE = 200
...
ZO_GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD_LEVEL_COLUMN_OFFSET_X = 200
        ...
        -- Report
        {
            ...
            callback = function()
                ...
                local function ReportCallback()
                    ...
                    local NO_MESSAGE = ""
                    local NO_BLACKLIST = true
                    DeclineGuildApplication(data.guildId, data.index, NO_MESSAGE, NO_BLACKLIST, NO_MESSAGE)
                end
...
function ZO_GuildRecruitment_ApplicationsList_Row_OnMouseEnter(control)
    GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD:GetSubcategoryManager(ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED):Row_OnMouseEnter(control)
end

function ZO_GuildRecruitment_ApplicationsList_Row_OnMouseExit(control)
    GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD:GetSubcategoryManager(ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED):Row_OnMouseExit(control)
end

function ZO_GuildRecruitment_ApplicationsList_Row_OnMouseUp(control, button, upInside)
    GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD:GetSubcategoryManager(ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED):Row_OnMouseUp(control, button, upInside)
end

function ZO_GuildRecruitment_ApplicationsList_Keyboard_OnInitialized(control)
    GUILD_RECRUITMENT_APPLICATIONS_KEYBOARD:SetSubcategoryManager(ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED, ZO_GuildRecruitment_ApplicationsList_Keyboard:New(control))
end
        ...
        buttons =
        {
            -- Confirm Button
            {
                ...
                callback = function(dialog)
                    ...
                    DeclineGuildApplication(dialog.data.guildId, dialog.data.index, declineMessage, isChecked, blacklistMessage)
                end,
            },
            -- Cancel Button
            {
