...
ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED = 1
...
local treeIdToCategoryInfo =
{
    ...
    [ZO_GUILD_RECRUITMENT_CATEGORY_KEYBOARD_APPLICATIONS] =
    {
        ...
        subCategories =
        {
            { name = GetString(SI_GUILD_RECRUITMENT_APPLICATIONS_RECIEVED), value = ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED },
...
function ZO_GuildRecruitment_Keyboard:ShowApplicationsList()
    if self:IsSceneShown() then
        local targetNode = self.nodeLookupTable[ZO_GUILD_RECRUITMENT_CATEGORY_KEYBOARD_APPLICATIONS].subCategories[ZO_GUILD_RECRUITMENT_APPLICATIONS_SUBCATEGORY_KEYBOARD_RECIEVED]
