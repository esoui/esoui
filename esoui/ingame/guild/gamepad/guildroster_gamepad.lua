        ...
        parametricList =
        {
            -- Backlist checkbox
            {
                ...
                templateData = {
                    ...
                    setup = function(control, data, selected, reselectingDuringRebuild, enabled, active)
                        enabled = DoesPlayerHaveGuildPermission(self.guildId, GUILD_PERMISSION_MANAGE_BLACKLIST)
            ...
            -- Remove applicant
            {
                ...
                templateData = {
                    ...
                    callback = function(dialog)
                        if self.addToBlacklist then
                            local blacklisted = AddToGuildBlacklist(dialog.data.guildId, dialog.data.displayName, self.blacklistNote)
